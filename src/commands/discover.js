...
const ENDPOINTS = ['customers', 'jobs', 'estimates', 'technicians', 'equipment', 'invoices'];
  ...
  program
    ...
    .action(async (entity) => {
      ...
      for (const ent of entities) {
        ...
        try {
          const response = await client.get(`/${ent}`, { params: { per_page: 1 } });
          ...
          console.log(chalk.green('    Available fields:'));
